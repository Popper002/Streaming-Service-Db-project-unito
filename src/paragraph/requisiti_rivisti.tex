...
\begin{itemize}
  ...
  Per utenit che creano contenuti invece:
    \begin{itemize}
      ...
      \item il numero medio di spettatori \footnote{Tutti questi dati si possono usare per far diventare uno \begin{italic} streamer affiliate \end{italic} } %TODO: questo si può vedere anche come vincolo%
    \end{itemize}
\end{itemize}
